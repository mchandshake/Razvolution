/* Decompiler 21ms, total 338ms, lines 179 */
...
public class CFont {
   ...
   protected wtf.evolution.helpers.font.CFont.CharData[] charData = new wtf.evolution.helpers.font.CFont.CharData[1105];
   protected Font font;
   ...
   protected DynamicTexture setupTexture(Font font, boolean antiAlias, boolean fractionalMetrics, wtf.evolution.helpers.font.CFont.CharData[] chars) {
   ...
   protected BufferedImage generateFontImage(Font font, boolean antiAlias, boolean fractionalMetrics, wtf.evolution.helpers.font.CFont.CharData[] chars) {
      this.getClass();
      int imgSize = 512;
      ...
      for(int i = 0; i <= chars.length; ++i) {
         ...
         if (ch > 1039 && ch < 1104 || ch < 256) {
            wtf.evolution.helpers.font.CFont.CharData charData = new wtf.evolution.helpers.font.CFont.CharData();
   ...
   public void drawChar(wtf.evolution.helpers.font.CFont.CharData[] chars, char c, float x, float y) throws ArrayIndexOutOfBoundsException {
      try {
