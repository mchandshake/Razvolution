/* Decompiler 4ms, total 282ms, lines 49 */
...
public final class FontRendererHook extends FontRenderer {
   private final wtf.evolution.helpers.font.FontRenderer fontRenderer;
   ...
   public FontRendererHook(Font font, boolean antiAliasing, boolean fractionalMetrics) {
      ...
      this.fontRenderer = new wtf.evolution.helpers.font.FontRenderer(font, antiAliasing, fractionalMetrics);
   }
