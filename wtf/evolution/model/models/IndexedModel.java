/* Decompiler 33ms, total 687ms, lines 154 */
...
import wtf.evolution.model.models.OBJLoader.OBJIndex;
...
public class IndexedModel {
   ...
   private ArrayList<OBJIndex> objindices = new ArrayList();
   ...
   public void toMesh(Mesh mesh) {
      ...
      Integer[] indicesArray = (Integer[])((Integer[])this.indices.toArray(new Integer[0]));
      Vertex[] verticesArray = (Vertex[])((Vertex[])verticesList.toArray(new Vertex[0]));
   ...
   public void computeTangents() {
      ...
      for(i = 0; i < this.indices.size(); i += 3) {
         ...
         double f = dividend == 0.0D ? 0.0D : 1.0D / dividend;
