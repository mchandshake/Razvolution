/* Decompiler 18ms, total 341ms, lines 75 */
...
import wtf.evolution.model.models.ObjEvent.EventType;
...
public abstract class ObjModel extends Model {
   ...
   public void renderGroup(ObjObject group) {
      if (this.fireEvent((new ObjEvent(this, EventType.PRE_RENDER_GROUP)).setData(new Object[]{group, group}))) {
         this.renderGroupImpl(group);
      }

      this.fireEvent((new ObjEvent(this, EventType.POST_RENDER_GROUP)).setData(new Object[]{group, group}));
   }

   public void renderGroups(String groupsName) {
      if (this.fireEvent((new ObjEvent(this, EventType.PRE_RENDER_GROUPS)).setData(new Object[]{groupsName}))) {
         this.renderGroupsImpl(groupsName);
      }

      this.fireEvent((new ObjEvent(this, EventType.POST_RENDER_GROUPS)).setData(new Object[]{groupsName}));
   }

   public void render() {
      if (this.fireEvent(new ObjEvent(this, EventType.PRE_RENDER_ALL))) {
         this.renderImpl();
      }

      this.fireEvent(new ObjEvent(this, EventType.POST_RENDER_ALL));
   }
